/*! `tlb` grammar compiled for Highlight.js 11.9.0 */
(()=>{var e=(()=>{"use strict";const e=/[a-zA-Z_][0-9a-zA-Z_]*/;return t=>({
...
variants:[t.C_BLOCK_COMMENT_MODE,t.C_LINE_COMMENT_MODE]},{scope:"symbol",
match:t.regex.either(/#[0-9a-f]*_?/,/\$[01]*_?/,/##/,/#<=/,/#</)},{
match:[/=/,/\s+/,e,/[\s;]/],scope:{1:"operator",3:"type"}},{scope:"variable",
match:e},{scope:"operator",
match:t.regex.either(/\+/,/-/,/\*/,/\//,/!=/,/==/,/=/,/\?/,/~/,/\./,/\^/,/<=/,/>=/,/</,/>/)
},{scope:"number",match:/[0-9]+/},{scope:"punctuation",match:/[;\(\):\[\]\{\}]/
}]})})();hljs.registerLanguage("tlb",e)})();